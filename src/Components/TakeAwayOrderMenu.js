...
export default function TakeAwayOrderMenu() {
        ...
        const handleToggleFavorite = async (item) => {
                ...
                try {
                        if (favoriteIds.includes(item._id)) {
                                const res = await BackendApis.RemoveFavItems(
                                        customerId,
                                        item._id,
                                        item.name
                                );
                                ...
                                const res = await BackendApis.AddFavItems(
                                        customerId,
                                        item._id,
                                        item.code,
                                        item.name
        ...
        const handleViewCart = () => {
                navigate(`/take-away/view-cart/${randomString}`);
        };
                        ...
                        {loading ? (
                                ...
                                <div className="viewmenu-container">
                                        <header className="menu-header">
                                                ...
                                                <p className="menu-header-p">
                                                        Choose from our freshly prepared menu items and add to your cart.
                                                </p>
                                        </header>
                                                                                                        ...
                                                                                                        >
                                                                                                                ...
                                                                                                                >
                                                                                                                        <div className="card-image-wrapper">
                                                                                                                                ...
                                                                                                                                />
                                                                                                                                <button
                                                                                                                                        className={`fav-button-overlay ${favoriteIds.includes(item._id)
                                                                                                                                                ? "active"
                                                                                                                                                : ""
                                                                                                                                                }`}
                                                                                                                                        onClick={() =>
